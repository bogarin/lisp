                ...
                (loop
                     ...
                     (when (equal m 'n)
                         (progn
                          ...
                          ;   (format t "tablero en el metodo genera-arbol: ~S~%"*tablero*)
                           (setf (nth pos copia) ficha) ;coloca la ficha en su lugar ficha es 'x o 'o (en copia)
                            ;  (format t "copia en el metodo genera-arbol: ~S~%"ficha)
    ...
    (defun buscar-jugada-anterior (tablero) ;funcion auxiliar que busca tablero anterior "first" en *tabla* y devuelve la
        (let ;jugada siguiente que debera ser eliminada
          ((jugada-siguiente nil))
            ...
            ;      (formatf t "contenido registro buscar-jugada-anterior: ~S~% primer registro: ~S~%" registro (first registro))
          ...
          ;(format t "contenido de tabla en el metodo buscar-jugada-anterior: ~S~%" *tabla* )
          jugada-siguiente))
